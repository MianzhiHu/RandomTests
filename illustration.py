...
# WA2
wa2_2025_fall = [40.5, 41, 34.5, 32, 29, 47, 38, 48, 35.5, 41, 27.5, 39, 37.5, 43, 38.5]
wa2_2025_fall = [x * 2 for x in wa2_2025_fall]
grade_reporter(wa2_2025_fall)

# WA3
wa3_2025_fall = [43, 34.5, 44.5, 48, 41, 42.5, 35.5, 45.5, 43.5, 37.5, 41, 40]
wa3_2025_fall = [x * 2 for x in wa3_2025_fall]
grade_reporter(wa3_2025_fall)
